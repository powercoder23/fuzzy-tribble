...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the best-tested index strategy as a Dhan-backed backtest.")
    ...
    parser.add_argument("--output", type=Path, default=Path("nifty_backtest_trades.csv"))
...
def main() -> None:
    ...
    print(f"{args.symbol_name} backtest complete")
