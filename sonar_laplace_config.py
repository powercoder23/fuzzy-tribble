...
Reads ONLY the intraday spot series from iv_history.db. Zero broker calls.
...
SMOOTH_PERIOD = int(os.getenv("SONAR_PERIOD", "12"))
...
MIN_POINTS = int(os.getenv("SONAR_MIN_POINTS", "12"))
...
SCAN_TIMES = os.getenv("SONAR_SCAN_TIMES", "09:45,11:30,13:30,15:15").split(",")
